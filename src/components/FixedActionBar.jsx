      ...
      <div className="hidden md:flex fixed bottom-12 right-5 z-[99999] items-center">
        ...
        >
          ...
          <div className="relative p-[2px] transition-all duration-500 rounded-md">
            <button
              title="Menu"
              className="relative flex items-center justify-center bg-teal-200 text-gray-700 p-4 rounded-md shadow-lg hover:brightness-110 transition-all duration-300"
            >
              <LayoutGrid size={22} />
            </button>
          </div>
          ...
          >
            <div className="bg-teal-200 px-3 py-2 shadow-lg flex items-center gap-3 rounded-l-md">
              <a
                href="#"
