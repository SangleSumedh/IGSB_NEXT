...
export default function Sports() {
  ...
  const healthCentreData = {
    description:
      "Indira Primary Health Centre is an In-house Medical Clinic Facility for Students and Staffs of IGSB campus. Medical Clinic is equipped with equipment needed for primary health management.",
    services: [
  ...
  const hostelData = {
    overview: {
      description:
        "IGSB is having Boys & Girls hostel facility with spacious rooms.",
      capacity: {
        girls: "168",
        boys: "126",
      },
      roomFacilities: ["Beds", "Study table", "Chairs", "Cupboard facility"],
    },
    managementTeam: [
      {
        name: "Mr. Dattatray Ovhal",
        designation: "Boys Hostel Warden",
        contact: "8788562431",
        email: "dattatraya.ovhal@indiraicem.ac.in",
      },
      {
        name: "Ms. Manisha Dhiwar",
        designation: "Girls Hostel Warden",
        contact: "9588475368",
        email: "Manisha.dhiwar@indiraicem.ac.in",
      },
      {
        name: "Ms. Sapna Dahake",
        designation: "Girls Hostel Warden",
        contact: "9699913109",
        email: "sapnadahake@indiraicem.ac.in",
      },
    ],
    messTeam: [
      {
        name: "Mr. Vikas Kumar Shetty – M/s Little Chef Canteen",
        designation: "Canteen Owner",
        contact: "9665869000",
        email: "",
      },
      {
        name: "Mr. Prajwal Shetty – M/s Little Chef Canteen",
        designation: "Canteen In-charge for Mess Fees",
        contact: "8310972775",
        email: "",
      },
    ],
        ...
        {activeSection === "Sports" ? (
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="list-disc pl-6 space-y-2 text-md md:text-lg text-gray-700">
                  ...
                  <li>
                    Indoor sports complex for table tennis, chess, and carrom
                  </li>
                  <li>
                    Outdoor playground for cricket, football, and athletics
                  </li>
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="mb-8">
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  The Library at Indira Global School of Business (IGSB) is a
                  vibrant hub of academic resources, supporting the MBA
                  programme with a rich and diverse collection of learning
                  materials, with a comprehensive collection of physical and
                  digital learning materials.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  Our library boasts a rich repository of 9150 books and 33
                  journals and 6 daily newspapers spanning various domains of
                  management, business, and allied disciplines. We utilize Koha,
                  an advanced integrated library management software, to
                  streamline operations and enhance user experience.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  IGSB is also a proud member and access of DELNET, J-Gate, NDLI
                  Club and Jayakar Library providing students and faculty access
                  to a vast network of digital resources and scholarly content.
                  Additionally, our digital library includes eBook collections
                  from leading publishers such as Tata McGraw-Hill and Pearson,
                  ensuring that learners have access to high-quality academic
                  content anytime, anywhere.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-8">
                  We also offer the student copy of Mint newspaper, a leading
                  business daily, to keep students updated with current affairs,
                  market insights, and economic developments—an essential
                  resource for aspiring business leaders.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed">
                  The library is committed to fostering a culture of research,
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="bg-gray-50 p-6 rounded-lg text-center">
                <p className="text-md md:text-lg text-gray-700">
                  Our canteen offers a variety of delicious, hygienic, and
                  affordable food options to cater to diverse tastes and dietary
                  preferences of students and staff.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-full mx-auto px-6 py-16">
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="mb-8">
                ...
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  IGSB has well equipped computer Lab with LAN connectivity. Lab
                  is effectively used in teaching learning process by both
                  Faculty and Student.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-6">
                  Institute has provided dedicated workstations for every
                  Faculty member. Faculty and staff are also provided with
                  laptops on need basis for ease of work and effective delivery
                  of assigned tasks. Every Faculty room has been provided
                  printers as shared resource and scanners are available in
                  library and computer room to be used as and when required.
                  Projection Television sets have been installed in the corridor
                  which is used for internal information dissemination and live
                  streaming business news channels to keep students and staff
                  updated on latest developments.
                </p>

                <h3 className="text-2xl md:text-4xl font-bold text-secondary mb-6 mt-8">
                  Network Resources
                </h3>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  Leased Line and Wi-Fi facility is available on campus for
                  seamless connectivity for users. One Drive which is a
                  Microsoft's service for hosting files in the "cloud" Office
                  Online services, is also available for all Outlook users.
                  Through this facility, files can be synced to a PC and
                  accessed from a web browser or a mobile device, as well as
                  shared publicly or with specific individuals.
                </p>
                ...
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-4">
                  IGSB Classrooms now opting for smart classrooms, aiming to
                  provide students with interactive, engaging, and modern
                  learning experiences. The idea is to leverage technology such
                  as projectors, interactive whiteboards, audio-visual aids, and
                  internet-enabled devices.
                </p>
                <p className="text-md md:text-lg text-gray-700 leading-relaxed mb-8">
                  Microsoft Teams is an online teaching and learning environment
                  where teachers and students can present course materials,
                  engage and interact with one another, and work in groups
                  together. The key distinction of a virtual classroom is that
                  it takes place in a live, synchronous setting. The language
                  lab interactive courses provide a very different experience
                  from the traditional system of teaching and learning English,
                  offering more advanced features and functionalities. The lab
                  offers the students a structured e-learning environment to
                  practice English in an entertaining and interactive way to
                  acquire the main language skills such as listening, speaking,
                  reading, and writing.
                </p>
              </div>
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="mb-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                  {[
                    "Indira_Primary_Health_Centre_1",
                    "Indira_Primary_Health_Centre_2",
                    "Indira_Primary_Health_Centre_3",
                    "Indira_Primary_Health_Centre_4",
                  ].map((item) => (
                    <div
                      key={item}
                      className="bg-gray-100 rounded-lg overflow-hidden shadow-md"
          ...
          <div className="max-w-full mx-auto px-6 py-16 space-y-12">
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-green-50 p-6 rounded-lg">
                  <h3 className="text-xl md:text-4xl font-bold text-green-800 mb-4">
                    Girls Hostel
                  </h3>
                  <div className="text-4xl font-bold text-green-600 mb-2">
                    {hostelData.overview.capacity.girls}
                  </div>
                  <p className="text-md md:text-lg text-gray-700">
                    Seats Available
                  </p>
                ...
                <div className="bg-blue-50 p-6 rounded-lg">
                  <h3 className="text-xl md:text-4xl font-bold text-blue-800 mb-4">
                    Boys Hostel
                  </h3>
                  <div className="text-4xl font-bold text-blue-600 mb-2">
                    {hostelData.overview.capacity.boys}
                  </div>
                  <p className="text-md md:text-lg text-gray-700">
                    Seats Available
                  </p>
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              ...
              <h4 className="text-xl md:text-4xl font-bold text-secondary mb-4">
                Mess Timings
              </h4>
              <div className="bg-green-50 p-6 rounded-lg">
            ...
            <div className="w-full bg-white p-8 rounded-xl shadow-md">
              <h3 className="text-2xl md:text-4xl font-bold text-secondary mb-6">
                Hostel Admission Cancellation Rules
              </h3>
              <div className="space-y-6">
                {hostelData.cancellationRules.map((rule, index) => (
                  ...
                  >
                    <h4 className="text-lg md:text-4xl font-bold text-red-800 mb-3">
                      {rule.title}
                    </h4>
              ...
              <div className="mt-6 bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
                <h4 className="text-lg md:text-4xl font-bold text-green-800 mb-3">
          ...
          <div className="max-w-full mx-auto px-6 py-16">
            <div className="w-full bg-white p-8 rounded-xl shadow-md text-center">
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                <p className="text-md md:text-lg text-gray-700 leading-relaxed">
                  Content for {activeSection} section is being updated. Please
                  check back later for detailed information about our{" "}
                  {activeSection.toLowerCase()} facilities and services.
                </p>
                <div className="mt-6 text-gray-500">
                  <p className="text-md md:text-lg">
                    For immediate assistance, please contact the administration
                    office.
                  </p>
                </div>
              </div>
