...
const Footer = () => {
  return (
    <footer className="bg-secondary border-t-4 border-[#FF8C1A] text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-5 md:order-1">
            {/* Logo */}
            <div className=" rounded-lg inline-block  mx-auto md:mx-0">
              <Image
                src="/whitelogo.png"
                alt="IGSB Logo"
                width={220}
            ...
            <div className="space-y-2 text-center md:text-left">
              ...
              <p className="leading-relaxed text-white/90 text-sm">
                S.No. 64, 65, Gat No. 276, Parandwadi, Near Somatnephata
                <br />
            ...
            {/* Mobile Contact */}
            <div className="space-y-3 text-sm text-white/90 text-center md:hidden">
              <div>
                <strong className="text-white/90">MBA:</strong> 9657856103 /
                02114691417
              </div>

              <div>
                <strong className="text-white/90">Administrative:</strong>{" "}
                9657856103
              </div>

              <div className="space-y-1">
                <div className="whitespace-nowrap overflow-hidden text-ellipsis">
                  <strong className="text-white/90">Exam:</strong>{" "}
                  exam.committee@indiragsb.edu.in
                </div>
                <div className="whitespace-nowrap overflow-hidden text-ellipsis">
                  <strong className="text-white/90">MBA:</strong>{" "}
                  mba.admissions@indiragsb.edu.in
                </div>
                <div className="whitespace-nowrap overflow-hidden text-ellipsis">
                  <strong className="text-white/90">Admin:</strong>{" "}
              ...
              <div>
                ...
                <div className="space-y-1">
                  <Link
                    ...
                    className="hover:text-[#FF8C1A] block"
                  >
                  ...
                  <Link
                    href="mailto:admin@indiraigsb.edu.in"
                    className="hover:text-[#FF8C1A] block"
                  >
          ...
          <div className="space-y-4 md:order-3">
            <details className="md:block lg:hidden">
              ...
              <ul className="mt-3 space-y-2 text-sm text-white/90">
                ...
                <li>
                  <Link href="/about/chanakya-edu">About Us</Link>
                </li>
                <li>
                  <Link href="/programs/mba">MBA Admissions</Link>
                </li>
                <li>
            ...
            <div className="hidden lg:block space-y-6 lg:pl-6">
              ...
              <ul className="space-y-3 text-sm text-white/90">
                <li>
                  <Link href="/" className="hover:text-[#FF8C1A]">
                    Home
                  </Link>
                </li>
                <li>
                  <Link
                    ...
                    className="hover:text-[#FF8C1A]"
                  >
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/programs/mba" className="hover:text-[#FF8C1A]">
                    MBA Admissions
                  </Link>
                </li>
                <li>
                  <Link href="/alumni" className="hover:text-[#FF8C1A]">
                    Alumni
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="hover:text-[#FF8C1A]">
                    Contact Us
                  </Link>
                </li>
                <li>
                  <Link href="/privacy-policy" className="hover:text-[#FF8C1A]">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/blogs" className="hover:text-[#FF8C1A]">
                    Blogs
                  </Link>
                </li>
              </ul>
          ...
          <div className="space-y-4 md:order-4 lg:order-3">
            <details className="md:block lg:hidden">
              ...
              <ul className="mt-3 space-y-2 text-sm text-white/90">
                ...
                <li>
                  <Link href="/campus-life/student-engagement">Engagement</Link>
                </li>
                <li>
                  <Link href="/campus-life/student-achievements">
                    Achievements
                  </Link>
                </li>
                <li>
                  <Link href="/facilities">Student Life</Link>
                </li>
                <li>
                  <Link
            ...
            <div className="hidden lg:block space-y-6">
              ...
              <ul className="space-y-3 text-sm text-white/90">
                ...
                <li>
                  <Link href="/facilities" className="hover:text-[#FF8C1A]">
                    Student Life
                  </Link>
                </li>
                <li>
